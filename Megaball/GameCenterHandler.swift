...
final class GameCenterHandler: NSObject {
    ...
    func syncUserDefaults() {
        ...
        UserDefaultsCloudSave().premiumSetting = adsSetting
        UserDefaultsCloudSave().premiumSetting = soundsSetting
        UserDefaultsCloudSave().premiumSetting = musicSetting
        UserDefaultsCloudSave().premiumSetting = hapticsSetting
        UserDefaultsCloudSave().premiumSetting = parallaxSetting
