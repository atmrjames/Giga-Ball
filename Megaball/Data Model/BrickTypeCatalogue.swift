    ...
    private static var behaviours: [Entry] {
        [
            ...
            Entry(name: name(of: .multiHit),
                  description: "Four stages deep. Each hit steps it down to the next, and the fourth destroys it. Clear Multi-Hit drops every one of them to a single hit; Reset Multi-Hit puts them all back.",
                  art: .behaviour(.multiHit),
                  isNew: false,
                  facts: [Fact(label: "Hits to destroy", value: "4"),
                          Fact(label: "Found in", value: "Every mode")]),

            Entry(name: name(of: .indestructibleOnce),
                  description: "A hit does not destroy it. It becomes an Indestructible ×2 instead, so the first hit makes the wall rather than breaking it.",
                  art: .behaviour(.indestructibleOnce),
                  isNew: false,
                  facts: [Fact(label: "Hits to destroy", value: "Cannot be destroyed"),
                          Fact(label: "Found in", value: "Every mode")]),

            Entry(name: name(of: .indestructibleAlways),
                  description: "A hit does nothing at all. Cleared only by Zap Indestructible, a Wrecking Ball or an explosion. Giga-Ball passes straight through one and leaves it standing.",
                  art: .behaviour(.indestructibleAlways),
                  isNew: false,
                  facts: [Fact(label: "Hits to destroy", value: "Cannot be destroyed"),
